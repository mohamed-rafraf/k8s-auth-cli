...
func init() {
	...
	userCmd.Flags().String("server", Config.Server, "Server that you want to deal with")
	userDeleteCmd.Flags().String("server", Config.Server, "Server that you want to deal with")
